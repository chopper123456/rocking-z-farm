...
// Get all grain inventory (shared org data)
...
router.post('/', async (req, res) => {
  try {
    ...
    const result = await db.query(
      ...
      [ORG_USER_ID, binNumber, grainType, quantity, moisture, notes]
    );
...
router.put('/:id', requireAdmin, async (req, res) => {
  try {
    ...
    const result = await db.query(
      ...
      [binNumber, grainType, quantity, moisture, notes, req.params.id, ORG_USER_ID]
    );
